        ...
        <div className="grid-item">
          ...
          <div className="contentBox">
            ...
            <p className="commonText">
              ...
              team of us. Everyone&rsquo;s opinion matters, and as a group, we are
              stronger. We firmly believe that teamwork makes the dream work.
            </p>
          </div>
        </div>
        <div className="grid-item">
          ...
          <div className="contentBox">
            <h2 className="getToHeading headingText">
              We are all in for the <span className="redText">environment</span>
            </h2>
            <p>
              TasteNow donates $1 penny for every purchase made from the app to
              an organization that takes care of our environment. We believe
              that with everyone&rsquo;s help, we can make a better world.
            </p>
          </div>
        </div>
      </div>
